        ...
        <div className="row align-items-center">
            <div className="col-6">
                ...
                <p>
                  ...
                  <b> ADI</b> yang berarti <b>besar, agung, baik, ideal atau sempurna </b> dan
                  kata <b>WIYATA</b> yang berarti <b>tempat dimana seseorang mendapatkan
                  ilmu pengetahuan, norma dan etika</b>. Sedangkan ADIWIYATA artinya
                  <b style={{color:"green"}}> tempat yang besar, agung, baik dan indah yang dimana tempat
                  itu digunakan oleh seseorang untuk mendapatkan ilmu
                  pengetahuan, norma dan etika</b>.
                </p>
            </div>
            <div className="col-6 text-center">
                <img src="https://sman15plg.sch.id/wp-content/uploads/2021/03/adiwiyata-293x300.png" width="80%" alt="" className="mx-auto"/>
            </div>
        </div>
      </div>
    </div>
